...
class NodeGraphPanel(wx.Panel):
    ...
    def load_default_pipeline(self):
        ...
        self.nodegraph.AddNode("FreqPhaseAlignment",nodeid='freqphasealignement0', pos=wx.Point(400, 120))
        self.nodegraph.AddNode("EddyCurrentCorrection",nodeid='eddyccurentcorrection0', pos=wx.Point(600, 100))
        self.nodegraph.AddNode("RemoveBadAverages",nodeid='removebadaverages0', pos=wx.Point(800, 120))
        self.nodegraph.AddNode("Average", nodeid='average0', pos=wx.Point(1000, 100))
        ...
        self.nodegraph.ConnectNodes(self.nodegraph.nodes['coil_combination_svd'].GetSockets()[0],self.nodegraph.nodes['freqphasealignement0'].GetSockets()[1])
