...
class LayoutFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.button_open_output_folder.SetToolTip("Open folder of the processing output")
        ...
        self.save_plots_button = wx.CheckBox(self.rightPanel, wx.ID_ANY, "Save plots")
        self.save_plots_button.SetToolTip("Enable/Disable saving plots in the output folder")
        self.save_plots_button.SetValue(True)
        self.save_raw_button = wx.CheckBox(self.rightPanel, wx.ID_ANY, "Save .raw files")
        self.save_raw_button.SetToolTip("Enable/Disable saving raw data in the output folder")
        self.save_raw_button.SetValue(False)
        
        self.textdropdown =  wx.StaticText(self.rightPanel, wx.ID_ANY, "Show plot of node:", style=wx.ALIGN_CENTRE_VERTICAL)
        ...
        self.StepSelectionSizer.Add(self.save_plots_button, 0, wx.ALL | wx.EXPAND, 5)
        self.StepSelectionSizer.Add(self.save_raw_button, 0, wx.ALL | wx.EXPAND, 5)
        ...
        self.Processing_Sizer.AddStretchSpacer(1)
