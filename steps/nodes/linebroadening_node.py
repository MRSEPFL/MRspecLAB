...
import api
from ..LineBroadening import LineBroadening


class LineBroadeningNode(api.Node):
    def __init__(self, nodegraph, id):
        api.Node.__init__(self, nodegraph, id)
        self.label = "Line Broadening"
        self.processing_step=LineBroadening()
    ...
    def NodeMeta(self):
        meta_info = {
            ...
            "description": "Perform Line Broadening on the received transients",
        }
        return meta_info
