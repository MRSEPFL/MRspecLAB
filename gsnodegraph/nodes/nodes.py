...
from gsnodegraph.gsnodegraph import NodeBase
...
#         self.outputs = {
#             "arraysignals": Output(idname="arraysignals", datatype="SIGNALS", label="Signals")
#         }
#         self.properties = {
#             "arraysignals_socketid": SignalsProp("arraysignals_socketid", label="Signals")
#         }
        
        
        
class FrequencyPhaseAlignementNode(NodeBase):
    """ Example node showing an input node. """
    def __init__(self, nodegraph, _id):
        NodeBase.__init__(self, nodegraph, _id)

        self.label = "Frequency-Phase Alignement"
...
class EddyCurrentCorrectionNode(NodeBase):
    """ Example node showing an input node. """
    def __init__(self, nodegraph, _id):
        NodeBase.__init__(self, nodegraph, _id)
...
class ZeroPaddingNode(NodeBase):
    """ Example node showing an input node. """
    def __init__(self, nodegraph, _id):
        NodeBase.__init__(self, nodegraph, _id)
...
class LineBroadeningNode(NodeBase):
    """ Example node showing an input node. """
    def __init__(self, nodegraph, _id):
        NodeBase.__init__(self, nodegraph, _id)

        self.label = "Line Broadening"
        self.category = "QUALITY CONTROL"
...
class RemoveBadAveragesNode(NodeBase):
    """ Example node showing an input node. """
    def __init__(self, nodegraph, _id):
        NodeBase.__init__(self, nodegraph, _id)
...
class TransientsProp(Property):
    """ Example property. """
    def __init__(self, idname, default=1, label="Transients", exposed=True, 
                 can_be_exposed=True, visible=True):
        Property.__init__(self, idname, default, label, exposed, 
                          can_be_exposed, visible)
        self.value = default
